...
// Browser acceptance scenarios intentionally reuse fixture users across viewport projects.
// Disable throttling only in this test-only plugin so production rate limits remain unchanged.
